...
class NativeWebVideoPlayer extends StatefulWidget {
  ...
  NativeWebVideoPlayer({required this.customVideoPlayerWebController})
...
class _NativeWebVideoPlayerState extends State<NativeWebVideoPlayer> {
  ...
  Widget build(BuildContext context) {
    return Directionality(
      ...
      child:
          _videoPlayerSettings.aspectRatio != null
              ? AspectRatio(
                aspectRatio: _videoPlayerSettings.aspectRatio!,
                child: HtmlElementView(viewType: _videoPlayerSettings.src),
              )
              : HtmlElementView(viewType: _videoPlayerSettings.src),
    );
  }
