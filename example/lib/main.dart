...
class _MyHomePageState extends State<MyHomePage> {
  ...
  final CustomVideoPlayerWebSettings _customVideoPlayerWebSettings =
      CustomVideoPlayerWebSettings(src: longVideo);

  @override
  void initState() {
    super.initState();

    _videoPlayerController = CachedVideoPlayerPlusController.network(longVideo)
      ..initialize().then((value) => setState(() {}));
    _videoPlayerController2 = CachedVideoPlayerPlusController.network(video240);
    _videoPlayerController3 = CachedVideoPlayerPlusController.network(video480);
